...
sed -i 's/Variable3 = "*.*"/Variable3 = "x86_64_5.15"/g' luci-app-gpsysupgrade/luasrc/model/cbi/gpsysupgrade/sysupgrade.lua
sed -i 's/Variable4 = "*.*"/Variable4 = "5.15"/g' luci-app-gpsysupgrade/luasrc/model/cbi/gpsysupgrade/sysupgrade.lua
...
sed -i 's/Variable3 = "*.*"/Variable3 = "x86_64_5.15"/g' luci-app-gpsysupgrade/root/usr/bin/upgrade.lua
sed -i 's/Variable4 = "*.*"/Variable4 = "5.15"/g' luci-app-gpsysupgrade/root/usr/bin/upgrade.lua
